...
def plot_book_ratings():
    ...
    book_titles, ol_ratings, gb_ratings = zip(*book_ratings)
    ...
    ax.set_xlabel("Titles")
    ax.set_ylabel("Average Ratings")
    ax.set_title("Comparison of Book Ratings from Open Library and Google Books")
    ax.set_xticks([i + bar_width for i in index])
    ax.set_xticklabels(book_titles, rotation=45)
    ax.legend()
